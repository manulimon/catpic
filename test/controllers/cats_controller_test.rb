...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { age: @cat.age, coat: @cat.coat, color: @cat.color, gender: @cat.gender, name: @cat.name, race: @cat.race }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { age: @cat.age, coat: @cat.coat, color: @cat.color, gender: @cat.gender, name: @cat.name, race: @cat.race }
    assert_redirected_to cat_path(assigns(:cat))
  end
