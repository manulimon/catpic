...
class PicsControllerTest < ActionController::TestCase
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post :create, pic: { date: @pic.date, desc: @pic.desc, exif: @pic.exif, header: @pic.header, url: @pic.url, user_id: @pic.user_id }
    end
  ...
  test "should update pic" do
    patch :update, id: @pic, pic: { date: @pic.date, desc: @pic.desc, exif: @pic.exif, header: @pic.header, url: @pic.url, user_id: @pic.user_id }
    assert_redirected_to pic_path(assigns(:pic))
  end
